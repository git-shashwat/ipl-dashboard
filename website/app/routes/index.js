...
// ----------- Pages Imports ---------------
import Analytics from './Dashboards/crop-examine';
...
import CropExaminePage from './Dashboards/crop-examine/crop-examine';
...
export const RoutedContent = () => {
    return (
        <Switch>
            ...
            <Route path="/sensor-monitor" exact component={CropMonitorPage} />
            <Route path="/crop-examine" exact component={CropExaminePage} />
