            ...
            <div className="bg-white" style={{ borderRadius: '20px' }}>
                <Row>
                    ...
                    <div className="mt-lg-4 d-flex flex-column align-items-center">
                        ...
                        <div className="mt-4">
                            <h5><b>Max Projected Value: {(Number(focussedSensorData.liveReading) + 2.37).toFixed(2)} <smal>{focussedSensorData.unit}</smal></b></h5>
                            <h5><b>Min Projected Value: {(Number(focussedSensorData.liveReading) - 2.37).toFixed(2)} <smal>{focussedSensorData.unit}</smal></b></h5>
                        </div>
                        ...
                        <Line 
                            data={{
                                ...
                                datasets: [{
                                    ...
                                    borderColor: focussedSensorData.theme,
